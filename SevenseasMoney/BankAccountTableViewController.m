...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.tableView registerNib:[UINib nibWithNibName:@"BankAccountTableViewCell" bundle:nil] forCellReuseIdentifier:@"BankAccountTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellIdentifier = @"BankAccountTableViewCell";
    BankAccountTableViewController *BankAccountTableVC = (BankAccountTableViewController*)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    
    return BankAccountTableVC;
}
